...
public class UDPConstant {
    ...
    public static final String IP_ADDRESS_LOCATION = "224.0.0.2"; //地址范围是224.0.0.0至239.255.255.255
    ...
    public static final int CELL_GROUP_SERIALIZABLE_BUF = 3096 ;
    public static final int SPOT_LOCATION_SERIALIZABLE_BUF = 1024 ;
    ...
    public static final int SEND_LOCATION_UPDATA_INTERVAL_MS = 100 ; // 由于设备的处理速度跟不上，设成 30ms 感觉和 100 差不多
    ...
    public enum Control {
        TOPO_START,TOPO_STOP,LOCA_START,LOCA_STOP
    }
}
